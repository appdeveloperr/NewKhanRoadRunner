...
import com.example.husnain.newproject.PrintPakage.util.StringUtil;
...
/*import com.example.kamalsubhani.eparking.Activities.MainActivity;
import com.example.kamalsubhani.eparking.PrintPakage.util.StringUtil;*/
...
public class P25Connector {
	...
	public void sendData(byte[] msg) throws P25ConnectionException {
		if (mSocket == null) {
			...
			Log.e("p25Connector","Printer Socket is not connected");
			//Utile.showAlertDialog("Printer Socket is not connected.", Constants.Application.APPLICATION_CONTEXT).show();
		}
		...
		try {
			...
			MainActivity.mConnector.disconnect();
			Log.e("p25Connector","Printer is not connected");
